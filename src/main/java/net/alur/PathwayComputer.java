...
public class PathwayComputer implements IPathwayComputer {
	...
	@Override
	public List<BoardSquare> computePathway(BoardSquare start, BoardSquare destination) 
	...
	// If we wanted to adjust this algorithm to use e.g. a queen instead of a knight, we could alter this function
